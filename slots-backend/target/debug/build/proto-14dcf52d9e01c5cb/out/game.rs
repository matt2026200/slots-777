...
pub mod game_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn spin(
            ...
            let path = http::uri::PathAndQuery::from_static("/game.Game/Spin");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("game.Game", "Spin"));
...
pub mod game_server {
    ...
    #[async_trait]
    pub trait Game: std::marker::Send + std::marker::Sync + 'static {
        async fn spin(
            &self,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/game.Game/Spin" => {
                    ...
                    struct SpinSvc<T: Game>(pub Arc<T>);
                    impl<T: Game> tonic::server::UnaryService<super::SpinRequest>
                    for SpinSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Game>::spin(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "game.Game";
    impl<T> tonic::server::NamedService for GameServer<T> {
