...
pub mod wallet_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn bet(
            ...
            let path = http::uri::PathAndQuery::from_static("/wallet.Wallet/Bet");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("wallet.Wallet", "Bet"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn win(
            &mut self,
            request: impl tonic::IntoRequest<super::WinRequest>,
        ) -> std::result::Result<tonic::Response<super::WinResponse>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/wallet.Wallet/Win");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("wallet.Wallet", "Win"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod wallet_server {
    ...
    pub trait Wallet: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn win(
            &self,
            request: tonic::Request<super::WinRequest>,
        ) -> std::result::Result<tonic::Response<super::WinResponse>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/wallet.Wallet/Bet" => {
                    ...
                    struct BetSvc<T: Wallet>(pub Arc<T>);
                    impl<T: Wallet> tonic::server::UnaryService<super::BetRequest>
                    for BetSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Wallet>::bet(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/wallet.Wallet/Win" => {
                    #[allow(non_camel_case_types)]
                    struct WinSvc<T: Wallet>(pub Arc<T>);
                    impl<T: Wallet> tonic::server::UnaryService<super::WinRequest>
                    for WinSvc<T> {
                        type Response = super::WinResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Wallet>::win(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "wallet.Wallet";
